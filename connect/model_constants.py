...
DEPARTMENTS = [
				...
				'App. Science and Eng. Department',
				'Centre for Nanotechnology',
				'Architecture Department',
				'Biotechnology Department',
				'Chemical Engineering Department',
				'Centre of Disaster Mitigation',
				...
				'Polymer and Process Eng. Department',
				'Physics Department',
				'WRDM Department',
]
...
CATEGORY_CHOICES = (
		...
		('ARM', 'Army'),
		('ICC', 'Indian Council for Cultural Relations'),
		('ITE', 'Indian Technical and Economic Cooperation Programme'),
		('QIP', 'Qualified Institutional Participant'),
)
